        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 mb-10">
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              <img
                src="/assets/Florida Dave Network logo.png"
                alt="Florida Dave"
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-muted-foreground leading-relaxed text-base max-w-xl">
              40-year-old entrepreneur building ideas out in the open — from
              content creation and video storytelling to domain investing and
              digital ventures. Documenting the real journey: the wins, the
              experiments, and the grind toward location freedom and a life
